...
/**
 * Shadowed honor custom context path in service definition https://github.com/spring-cloud/spring-cloud-netflix/issues/737
 *
 * @author Spencer Gibb
 */
...
public class EurekaDiscoveryClient implements DiscoveryClient {
	...
	public static class EurekaServiceInstance implements ServiceInstance {
		...
		@Override
		public URI getUri() {
			//HACK to create proper URI with context-path
//			return DefaultServiceInstance.getUri(this);
